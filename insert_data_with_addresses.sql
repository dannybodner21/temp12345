-- Insert 5 LA test providers with addresses
INSERT INTO public.service_providers (business_name, address, city, state, latitude, longitude) VALUES
('Beverly Hills Spa & Wellness', '123 Rodeo Drive', 'Beverly Hills', 'CA', 34.0736, -118.4004),
('Santa Monica Beach Massage', '456 Santa Monica Blvd', 'Santa Monica', 'CA', 34.0195, -118.4912),
('Hollywood Beauty Studio', '789 Hollywood Blvd', 'Hollywood', 'CA', 34.0928, -118.3287),
('West Hollywood Nail Lounge', '321 Sunset Strip', 'West Hollywood', 'CA', 34.0900, -118.3617),
('Downtown LA Wellness Center', '555 Spring Street', 'Los Angeles', 'CA', 34.0522, -118.2437)
